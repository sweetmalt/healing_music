            ...
            child: Screenshot(
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      title: Text(
                        "总能量得分：${controller.totalEnergy.value}",
                        style: TextStyle(
                          fontSize: 16,
                          color: ThemeData().colorScheme.primary,
                          fontWeight: FontWeight.bold,
                      ...
                      subtitle: Text(
                          "其中，\n心理能量得分：${controller.bciEnergy.value}\n生理能量得分：${controller.hrvEnergy.value}"),
                    ),
                    // const ListTile(
                    //   title: Text(
                    //       "能量积分：__相比上次测试，您本次总得分增加__分，奖励积分__，请再接再厉，保持健康好心情！"),
                    // ),
                    ...
                    ListTile(
                      ...
                      subtitle:
                          Text("额温(${controller.bciTemperature["mv"]}摄氏度)"),
                    ),
                    // SingleChildScrollView(
                    //   scrollDirection: Axis.horizontal,
                    //   child: Row(children: [
...
class ReporPageController extends GetxController {
  ...
  ///总能量、心理能量、生理能量
  RxDouble totalEnergy = 0.0.obs;
  RxDouble bciEnergy = 0.0.obs;
  RxDouble hrvEnergy = 0.0.obs;
  ...
  Future<void> getReport(String fileName) async {
    ...
    _report['sleep_p2q1'] = report['sleep_p2q1'];
    _report['sleep_p2q2'] = report['sleep_p2q2'];
    _report['sleep_p2q3'] = report['sleep_p2q3'];
    _report['sleep_p3q1'] = report['sleep_p3q1'];
    _report['sleep_p3q2'] = report['sleep_p3q2'];

    String sleepP2q1 = "";
    if (_report['sleep_p2q1'] != "") {
      sleepP2q1 = "平均入睡时间需要${_report['sleep_p2q1']}";
    }
    String sleepP2q2 = _report['sleep_p2q2'];
    String sleepP2q3 = "";
    if (_report['sleep_p2q3'] != "") {
      sleepP2q3 = "对当前睡眠质量${_report['sleep_p2q3']}";
    }
    String sleepP3q1 = "";
    if (_report['sleep_p3q1'] != "") {
      sleepP3q1 = "近期感受到的压力主要来自${_report['sleep_p3q1']}";
    }
    String sleepP3q2 = "";
    if (_report['sleep_p3q2'] != "") {
      sleepP3q2 = "经常出现以下情绪：${_report['sleep_p3q2']}";
    }
    ...
    ///能量计算
    bciEnergy.value = (bciMed["mv"] +
            bciAtt["mv"] +
            curFlow["mv"] +
            curRelax["mv"] +
            bciAp["mv"] * 20) *
        0.2;
    bciEnergy.value = (bciEnergy.value * 10).toInt() / 10;
    hrvEnergy.value = (hrvRR["nn50"] + (5 - hrvRR["lfhf"]) * 20) * 0.5;
    hrvEnergy.value = (hrvEnergy.value * 10).toInt() / 10;
    totalEnergy.value = (bciEnergy.value + hrvEnergy.value) * 0.5;
    totalEnergy.value = (totalEnergy.value * 10).toInt() / 10;
    ...
    _aiPrompt = [
      ...
      "松弛度${curRelax["mv"]}%",
      "愉悦感${bciAp["mv"] * 20}%",
      "心率变异性NN50值${hrvRR["nn50"] * 100}%",
      "心率变异性LF/HF比值${hrvRR["lfhf"] * 20}%",
      sleepP2q1,
      sleepP2q2,
      sleepP2q3,
      sleepP3q1,
